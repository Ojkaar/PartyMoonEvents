...
$query_postre = "SELECT id, nombre, url_imagen FROM postres";
$resultado = ObtenerRegistros($query_postre);
?>
...
<head>
    ...
    <title>Ordenes de postres - MoonPartyEvents</title>
...
<div class="container mt-5 main-container">
    <div class="main-content">
        <h1 class="section-header">Servicio de catering</h1>
        <p class="text-center text-muted">¡Elige entre nuestros mejores postres o reposteria para que tu fiesta sea todo un éxito!</p>
        <p class="text-center text-muted"> <u> En caso de necesitar postres o reposteria que no este en el catalago contactanos via whatsapp </u></p>
...
<script>
    ...
    // Función para verificar inicio de sesión antes de acceder a un artículo
    function checkLogin(id) {
        if (id) {
            window.location.href = 'detalle_postre.php?id=' + id;
        } else {
