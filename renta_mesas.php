...
$query_mesas = "SELECT id, nombre, url_imagen FROM mesas";
$resultado = ObtenerRegistros($query_mesas);
?>
...
<head>
    ...
    <title>Renta de mesas - MoonPartyEvents</title>
...
<div class="container mt-5 main-container">
    <div class="main-content">
        <h1 class="section-header">Renta de mesas</h1>
        <p class="text-center text-muted">¡Elige entre nuestras mejores mesas para que tu fiesta sea todo un éxito!</p>
...
<script>
    ...
    function checkLogin(id) {
        if (id) {
            window.location.href = 'detalle_mesas.php?id=' + id;
        } else {
