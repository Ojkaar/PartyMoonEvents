...
$query_sillas = "SELECT id, nombre, url_imagen FROM sillas";
$resultado = ObtenerRegistros($query_sillas);
?>
...
<head>
    ...
    <title>Renta de sillas - MoonPartyEvents</title>
...
<div class="container mt-5 main-container">
    <div class="main-content">
        <h1 class="section-header">Renta de sillas</h1>
        <p class="text-center text-muted">¡Elige entre nuestros mejores sillas para que tu fiesta sea todo un éxito!</p>
...
<script>
    ...
    function checkLogin(id) {
        if (id) {
            window.location.href = 'detalle_sillas.php?id=' + id;
        } else {
