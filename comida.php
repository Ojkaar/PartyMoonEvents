...
$query_comida = "SELECT id, nombre, url_imagen FROM comidas";
$resultado = ObtenerRegistros($query_comida);
?>
...
<head>
    ...
    <title>Ordenes de comida - MoonPartyEvents</title>
...
<div class="container mt-5 main-container">
    <div class="main-content">
        ...
        <p class="text-center text-muted">¡Elige entre nuestras mejores comidas para que tu fiesta sea todo un éxito!</p>
        <p class="text-center text-muted"> <u> En caso de necesitar comida que no este en el catalago contactanos via whatsapp </u></p>
...
<script>
    ...
    function checkLogin(id) {
        if (id) {
            window.location.href = 'detalle_comida.php?id=' + id;
        } else {
