...
$query_inflables = "SELECT id, nombre, url_imagen FROM inflables";
$resultado = ObtenerRegistros($query_inflables);
?>
...
<div class="container mt-5 main-container">
    <div class="main-content">
        <h1 class="section-header">Renta de Inflables</h1>
        <p class="text-center text-muted">¡Elige entre nuestros inflables más divertidos para que tu fiesta sea todo un éxito!</p>
...
<script>
    ...
    function checkLogin(id) {
        if (id) {
            window.location.href = 'detalle_inflable.php?id=' + id;
        } else {
